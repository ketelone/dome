  ...
  .run(function ($ionicPlatform, $translate, baseConfig) {
    ...
    document.addEventListener('deviceready', function () {
      ...
      db.transaction(function (tx) {
        ...
        tx.executeSql('INSERT INTO T_CTM_PARTY_BOX_DEVICE (BOX_DEVICE_ID, PARTY_ID, DEVICE_ID, REFERENCE_SOURCE, CREATION_DATE,CREATED_BY,LAST_UPDATE_DATE, LAST_UPDATED_BY) VALUES (1, "13469950960", 1, "RESIDENTIAL", "2017-04-22 17:00:00", "-1", "2017-04-22 17:00:00", "-1")');
        tx.executeSql('INSERT INTO T_CTM_PARTY_BOX_DEVICE (BOX_DEVICE_ID, PARTY_ID, DEVICE_ID, REFERENCE_SOURCE, CREATION_DATE,CREATED_BY,LAST_UPDATE_DATE, LAST_UPDATED_BY) VALUES (2, "13469950960", 2, "RESIDENTIAL", "2017-04-22 17:00:00", "-1", "2017-04-22 17:00:00", "-1")');
        tx.executeSql('INSERT INTO T_CTM_PARTY_BOX_DEVICE (BOX_DEVICE_ID, PARTY_ID, DEVICE_ID, REFERENCE_SOURCE, CREATION_DATE,CREATED_BY,LAST_UPDATE_DATE, LAST_UPDATED_BY) VALUES (3, "13469950960", 3, "RESIDENTIAL", "2017-04-22 17:00:00", "-1", "2017-04-22 17:00:00", "-1")');
        tx.executeSql('INSERT INTO T_CTM_PARTY_BOX_DEVICE (BOX_DEVICE_ID, PARTY_ID, DEVICE_ID, REFERENCE_SOURCE, CREATION_DATE,CREATED_BY,LAST_UPDATE_DATE, LAST_UPDATED_BY) VALUES (4, "13469950960", 4, "RESIDENTIAL", "2017-04-22 17:00:00", "-1", "2017-04-22 17:00:00", "-1")');
        tx.executeSql('INSERT INTO T_CTM_PARTY_BOX_DEVICE (BOX_DEVICE_ID, PARTY_ID, DEVICE_ID, REFERENCE_SOURCE, CREATION_DATE,CREATED_BY,LAST_UPDATE_DATE, LAST_UPDATED_BY) VALUES (5, "13469950960", 5, "RESIDENTIAL", "2017-04-22 17:00:00", "-1", "2017-04-22 17:00:00", "-1")');
        tx.executeSql('INSERT INTO T_CTM_PARTY_BOX_DEVICE (BOX_DEVICE_ID, PARTY_ID, DEVICE_ID, REFERENCE_SOURCE, CREATION_DATE,CREATED_BY,LAST_UPDATE_DATE, LAST_UPDATED_BY) VALUES (6, "13469950960", 6, "RESIDENTIAL", "2017-04-22 17:00:00", "-1", "2017-04-22 17:00:00", "-1")');
        tx.executeSql('INSERT INTO T_CTM_PARTY_BOX_DEVICE (BOX_DEVICE_ID, PARTY_ID, DEVICE_ID, REFERENCE_SOURCE, CREATION_DATE,CREATED_BY,LAST_UPDATE_DATE, LAST_UPDATED_BY) VALUES (7, "13469950960", 7, "RESIDENTIAL", "2017-04-22 17:00:00", "-1", "2017-04-22 17:00:00", "-1")');


        tx.executeSql('INSERT INTO T_DVM_DEVICE (DEVICE_ID, PRODUCT_ID, SKU_ID, SKU_NUMBER, DEVICE_SERIAL_NUMBER,DEVICE_NAME, LOCATION,CONNECT_MODE, CREATION_DATE,CREATED_BY,LAST_UPDATE_DATE, LAST_UPDATED_BY, REFERENCE_SOURCE, OBJECT_VERSION_NUMBER) VALUES (1,1,1,"1122","123456","numi","上海","wifi", "2017-04-22 17:00:00", "-1", "2017-04-22 17:00:00", "-1", "RESIDENTIAL", 1)');
        tx.executeSql('INSERT INTO T_DVM_DEVICE (DEVICE_ID, PRODUCT_ID, SKU_ID, SKU_NUMBER, DEVICE_SERIAL_NUMBER,DEVICE_NAME, LOCATION,CONNECT_MODE, CREATION_DATE,CREATED_BY,LAST_UPDATE_DATE, LAST_UPDATED_BY, REFERENCE_SOURCE, OBJECT_VERSION_NUMBER) VALUES (2,2,2,"2233","234567","bathroomHeader","上海","wifi", "2017-04-22 17:00:00", "-1", "2017-04-22 17:00:00", "-1", "RESIDENTIAL", 1)');
        tx.executeSql('INSERT INTO T_DVM_DEVICE (DEVICE_ID, PRODUCT_ID, SKU_ID, SKU_NUMBER, DEVICE_SERIAL_NUMBER,DEVICE_NAME, LOCATION,CONNECT_MODE, CREATION_DATE,CREATED_BY,LAST_UPDATE_DATE, LAST_UPDATED_BY, REFERENCE_SOURCE, OBJECT_VERSION_NUMBER) VALUES (3,3,3,"3344","445677","airfoilShower","上海","box", "2017-04-22 17:00:00", "-1", "2017-04-22 17:00:00", "-1", "RESIDENTIAL", 1)');
        tx.executeSql('INSERT INTO T_DVM_DEVICE (DEVICE_ID, PRODUCT_ID, SKU_ID, SKU_NUMBER, DEVICE_SERIAL_NUMBER,DEVICE_NAME, LOCATION,CONNECT_MODE, CREATION_DATE,CREATED_BY,LAST_UPDATE_DATE, LAST_UPDATED_BY, REFERENCE_SOURCE, OBJECT_VERSION_NUMBER) VALUES (4,4,4,"4455","352234","karess","上海","box", "2017-04-22 17:00:00", "-1", "2017-04-22 17:00:00", "-1", "RESIDENTIAL", 1)');
        tx.executeSql('INSERT INTO T_DVM_DEVICE (DEVICE_ID, PRODUCT_ID, SKU_ID, SKU_NUMBER, DEVICE_SERIAL_NUMBER,DEVICE_NAME, LOCATION,CONNECT_MODE, CREATION_DATE,CREATED_BY,LAST_UPDATE_DATE, LAST_UPDATED_BY, REFERENCE_SOURCE, OBJECT_VERSION_NUMBER) VALUES (5,5,5,"5566","753222","mc","上海","wifi", "2017-04-22 17:00:00", "-1", "2017-04-22 17:00:00", "-1", "RESIDENTIAL", 1)');
        tx.executeSql('INSERT INTO T_DVM_DEVICE (DEVICE_ID, PRODUCT_ID, SKU_ID, SKU_NUMBER, DEVICE_SERIAL_NUMBER,DEVICE_NAME, LOCATION,CONNECT_MODE, CREATION_DATE,CREATED_BY,LAST_UPDATE_DATE, LAST_UPDATED_BY, REFERENCE_SOURCE, OBJECT_VERSION_NUMBER) VALUES (6,6,6,"6677","983435","ng","上海","box", "2017-04-22 17:00:00", "-1", "2017-04-22 17:00:00", "-1", "RESIDENTIAL", 1)');
        tx.executeSql('INSERT INTO T_DVM_DEVICE (DEVICE_ID, PRODUCT_ID, SKU_ID, SKU_NUMBER, DEVICE_SERIAL_NUMBER,DEVICE_NAME, LOCATION,CONNECT_MODE, CREATION_DATE,CREATED_BY,LAST_UPDATE_DATE, LAST_UPDATED_BY, REFERENCE_SOURCE, OBJECT_VERSION_NUMBER) VALUES (7,7,7,"7788","383464","ro","上海","wifi", "2017-04-22 17:00:00", "-1", "2017-04-22 17:00:00", "-1", "RESIDENTIAL", 1)');


        tx.executeSql("INSERT INTO T_CTM_PARTY_SCENARIO (SCENARIO_ID,PARTY_ID,PLUGIN_ID,SCENARIO_TYPE,SCENARIO_CODE,SCENARIO_NAME,REFERENCE_SOURCE,SCENARIO_STATUS,CREATION_DATE,CREATED_BY,LAST_UPDATE_DATE,LAST_UPDATED_BY,LAST_UPDATE_LOGIN,OBJECT_VERSION_NUMBER)VALUES (1,13469950960,1,'atuo','trigger','离家','RESIDENTIAL','Y','2017-04-18 06:16:51.297','-1','2017-04-18 06:16:51.297','-1','-1','1')");
        tx.executeSql("INSERT INTO T_CTM_PARTY_SCENARIO (SCENARIO_ID,PARTY_ID,PLUGIN_ID,SCENARIO_TYPE,SCENARIO_CODE,SCENARIO_NAME,REFERENCE_SOURCE,SCENARIO_STATUS,CREATION_DATE,CREATED_BY,LAST_UPDATE_DATE,LAST_UPDATED_BY,LAST_UPDATE_LOGIN,OBJECT_VERSION_NUMBER)VALUES (2,13469950960,2,'atuo','trigger','晨起','RESIDENTIAL','Y','2017-04-18 06:16:51.297','-1','2017-04-18 06:16:51.297','-1','-1','1')");
        tx.executeSql("INSERT INTO T_CTM_PARTY_SCENARIO (SCENARIO_ID,PARTY_ID,PLUGIN_ID,SCENARIO_TYPE,SCENARIO_CODE,SCENARIO_NAME,REFERENCE_SOURCE,SCENARIO_STATUS,CREATION_DATE,CREATED_BY,LAST_UPDATE_DATE,LAST_UPDATED_BY,LAST_UPDATE_LOGIN,OBJECT_VERSION_NUMBER)VALUES (3,13469950960,3,'atuo','trigger','淋浴','RESIDENTIAL','Y','2017-04-18 06:16:51.297','-1','2017-04-18 06:16:51.297','-1','-1','1')");
