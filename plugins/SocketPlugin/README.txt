...
5.cordova.plugins.SocketPlugin.tcpClose    //断开tcp连接
...
3.cordova.plugins.SocketPlugin.tcpSendCmd({"timeout":"5000”,”value”:cmd},success , error);

4.cordova.plugins.SocketPlugin.getTcpStatus(arg,success , error);

5.cordova.plugins.SocketPlugin.tcpClose (arg，success,error)
